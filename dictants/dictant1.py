"Cоздать список из чисел в диапазоне от 1-10"
#1
...
"В список добавить по индексу число 11"
#1
list1.insert(2,11)
#2
list1 = list1[:2] + [11] + list1[2:0]
#3
new_list = []
index = 0
for i in list1:
...
"Создайте класс Person с аттрибутом класса arms=2, legs=2 и аттрибутом объекта name"
