...
"super() - функция  которая позволяет обратиться к родительскому классу вызвать определенные  методы или аттрибуты"  
...
obj_b.my_range() #[0,1,2,4,5,6,7,8,9,10]
...
class C(A,B):
    """Наследовались от 2 классов А и B"""
    c = 'c'
